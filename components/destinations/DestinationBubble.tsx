...
export function DestinationBubble({ destination, itemCount, onClick, onDragStart, isDragging }: DestinationBubbleProps) {
    ...
    <div
      ...
      style={{
        ...
        boxShadow: isDragging
          ? `0 16px 48px ${destination.color}55`
          : `0 8px 28px ${destination.color}33`,
      }}
      onClick={onClick}
